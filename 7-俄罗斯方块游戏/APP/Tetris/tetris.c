...
void Show_TetrisFace(void)
{
	...
	FRONT_COLOR=RED;
	BACK_COLOR=GBLUE;
	LCD_ShowString(10,300,tftlcd_data.width,tftlcd_data.height,16,"KEY_UP:TURN");
	LCD_ShowString(10,320,tftlcd_data.width,tftlcd_data.height,16,"KEY0:RIGHT");
	LCD_ShowString(10,340,tftlcd_data.width,tftlcd_data.height,16,"KEY1:LEFT");
